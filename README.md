# New Relic Go Agent [![GoDoc](https://godoc.org/github.com/lulzWill/go-agent?status.svg)](https://godoc.org/github.com/lulzWill/go-agent)
...
```
go get github.com/lulzWill/go-agent
```

Then import the `github.com/lulzWill/go-agent` package in your application.
